    ...
    <div class="col-12 justify-between align-items-center">
        <div class="col-md-6 mb-3">
            ...
            <button type="button" class="btn btn-primary">
                <a href="{{ route('destinataires.create') }}" class="text-white fs-6" style="text-decoration:none;"><i
                        class="fas fa-plus"></i>Ajouter destinataire</a></button>
            ...
            <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed table-striped ">
                    ...
                    <tbody>
                        ...
                        @foreach ($listeDestinataire as $item)
                            <tr>
                                <td>{{ $item->nom }}</td>
                                <td>{{ $item->contact }}</td>
                                <td>{{ $item->adresse }}</td>
                                ...
                                {{--   <td class="text-center">
                                    <a href="{{ route('destinataires.edit', $item->id) }}"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            <a class="dropdown-item"
                                                href="{{ route('destinataires.edit', $item->id) }}">
                                                <i class="fas fa-edit" aria-hidden="true"></i>
                                                Modifier
                                            </a>

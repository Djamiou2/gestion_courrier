                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{-- <span class=" text-sm " style="size: 2px";>La longueur des caractères de l'objet:
                                </span>
                                <h6 x-text="$wire.objet.length" class="text-danger"></h6> --}}
                                @error('objet')
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <div x-data="{ pdfUrl: '' }">
                                <!-- Votre formulaire pour le téléchargement du fichier PDF -->
                                <input type="file" @change="previewPDF($event)">
...
<script>
    function previewPDF(event) {
        ...
        if (file && file.type === 'application/pdf') {
            ...
            reader.onload = () => {
                // Mise à jour de l'URL du PDF pour afficher l'aperçu
                Alpine.data['x-data'].pdfUrl = reader.result;
            };
            reader.readAsDataURL(file);
        } else {
            // Réinitialiser l'URL si le fichier n'est pas un PDF
            Alpine.data['x-data'].pdfUrl = '';
        }
    }
</script>

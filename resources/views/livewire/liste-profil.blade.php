    ...
    <div class="col-12 justify-between align-items-center">
        <div class="col-md-6 mb-3">
            ...
            <button type="button" class="btn btn-primary">
                <a href="{{ route('admin.profils.profils.create') }}" class="text-white fs-6"
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex align-items-center ">
                ...
                <div class="card-tools d-flex align-items-center ">
                    ...
                    <!-- <a href="{{ route('admin.profils.profils.create') }}" class=" btn btn-link text-white
           mr-4 d-block">
                        ...
                        @foreach ($profils as $item)
                            <tr>
                                ...
                                {{-- <td class="text-center">
                                    ...
                                    <a href="{{ route('admin.profils.profils.edit', $item->id) }}"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            <a class="dropdown-item"
                                                href="{{ route('admin.profils.profils.edit', $item->id) }}">
                                                <i class="fas fa-edit" aria-hidden="true"></i>
                                                Modifier
                                            </a>
